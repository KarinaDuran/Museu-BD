...
private Connection connection;
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        else if(jRadioButton2.isSelected())query += " YEAR(DataAquisicao) AS Data FROM PERMANENTES GROUP BY YEAR(DataAquisicao);";
      ...
      DefaultCategoryDataset ds = new DefaultCategoryDataset();
            ...
            JFreeChart lineChart = ChartFactory.createLineChart("teste", "Data","Quantidade",  ds, PlotOrientation.VERTICAL, true,true,false);
