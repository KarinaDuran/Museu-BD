...
public class PaginaEmprestimosLista extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        TabelaEmprestados.setBackground(new java.awt.Color(249, 246, 246));
        TabelaEmprestados.setFont(new java.awt.Font("Kailasa", 0, 13)); // NOI18N
        ...
        TabelaEmprestados.setGridColor(new java.awt.Color(102, 0, 0));
    ...
    private void EnviarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_EnviarActionPerformed
        ...
        if (BotaoMes.isSelected()) {
            query += " MONTH(E.DataEmprestimo) = " + Mes.getText();
        } else if (BotaoAno.isSelected()) {
            query += " YEAR(E.DataEmprestimo) = " + Ano.getText();
        }

        DefaultTableModel tableModel = (DefaultTableModel) TabelaEmprestados.getModel();
        try {
